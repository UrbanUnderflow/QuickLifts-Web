# Macra Operating Snapshot - 2026-07-07
...
- **Evidence:** Pending population from `docs/ops/macra-operating-snapshot-2026-07-07.md`, `/admin/experiments`, Firestore `macra-experiments/macra_paywall_onboarding`, Firestore `macra-experiment-results/macra_paywall_onboarding`, AppsFlyer imports, purchase logs, cancel reasons, and user state.
...
- **Decision-log impact:** append the July 7 Nora recommendation to `.agent/macra/decisions.md` during the decision-log step after this snapshot has source evidence.

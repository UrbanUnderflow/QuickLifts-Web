...
### 1. Nike Run Club (Global)
- **Brief description (Unverified):** Brand-backed global run community built around the Nike Run Club app, with city crews hosting weekly guided group runs.
- **Estimated size (Unverified):** Well into the tens of thousands of active members worldwide; individual city crews commonly exceed **200+ active runners** over a season. Source: https://www.nike.com/nrc-app
- **Location / scope:** Global, with city-based run crews in major metros (e.g., NYC, London, LA).
- **How they organize weekly runs:** Primarily through the Nike Run Club (NRC) mobile app and localized event pages; city crews often maintain Instagram accounts for announcements and sign-ups.
- **Main community hub / events URL:** https://www.nike.com/nrc-app
- **Tooling stack (Unverified):** NRC mobile app for run tracking and programming, Nike membership accounts for authentication, plus Instagram for local crew communication and storytelling (e.g., city accounts linking back to NRC events). Source: https://www.nike.com/nrc-app
- **Attendance / accountability (Unverified):** App-based event registration and run logs; badges/challenges inside NRC incentivize repeat participation rather than manual attendance checks. Source: https://www.nike.com/nrc-app
- **Social content from runs (Unverified):** Heavy emphasis on Instagram and user-generated content using NRC-branded hashtags; recap posts and stories highlight group runs rather than surfacing in-app social feeds. Source: https://www.nike.com/nrc-app

### 2. November Project (Multi-city, North America & Europe)
- **Brief description (Unverified):** Free, outdoor, early-morning fitness and run community built on a “show up” culture, with city-led weekly workouts.
- **Estimated size (Unverified):** Dozens of global chapters, many reportedly drawing **200+ recurring participants** across their weekly sessions over time. Source: https://november-project.com/
- **Location / scope:** Multi-city grassroots fitness and running community with chapters across the U.S., Canada, and select international cities.
- **How they organize weekly runs:** Central website with city-specific pages that list weekly workouts; many chapters also use Facebook/Instagram for event reminders and photos.
- **Main community hub / events URL:** https://november-project.com/
- **Tooling stack (Unverified):** Central WordPress-style site for chapter listings and schedules, plus chapter-level Facebook pages and Instagram accounts for announcements and RSVP details. Source: https://november-project.com/
- **Attendance / accountability (Unverified):** Largely attendance-by-showing-up; some cities may use FB event RSVPs or photo tags to track regulars, but the culture leans toward open, no-signup workouts. Source: https://november-project.com/
- **Social content from runs (Unverified):** Strong culture of posting workout photos, “we showed up” group shots, and city-specific hashtags on Instagram and Facebook; content lives on social platforms rather than a centralized app feed. Source: https://november-project.com/

### 3. Black Girls RUN! (United States)
- **Brief description (Unverified):** National running organization focused on encouraging Black women to run, with local groups hosting regular group runs and training events.
- **Estimated size (Unverified):** Community frequently described as having **thousands of members** across the U.S., with many city chapters likely supporting **200+ active members** over a given year. Source: https://blackgirlsrun.com/
- **Location / scope:** National U.S. network of local run groups focused on Black women, with chapters in dozens of cities.
- **How they organize weekly runs:** Central website with chapter directory; many local groups coordinate weekly runs via Facebook Groups and email lists linked from the main site.
...
- **Brief description (Unverified):** Night-time urban run club blending running with music and social atmosphere, operating in major cities with weekly “bootcamp run” style sessions.
- **Estimated size (Unverified):** Several global hubs, with flagship cities (e.g., London) reportedly drawing **hundreds of runners per week** during peak season; likely **200+ active members** per major city crew over time. Source: https://www.midnightrunners.com/
- **Location / scope:** Urban run club with hubs in major cities including London, Berlin, Boston, and others.
- **How they organize weekly runs:** Official website listing city hubs and weekly “bootcamp run” events; city-specific Instagram accounts used to announce runs and share recap content.
...
### 5. GoodGym (UK)
- **Brief description (Unverified):** UK-wide community that pairs running with volunteering, where members run to community projects and group runs are structured around doing good.
- **Estimated size (Unverified):** Multiple UK cities with active GoodGym operations; aggregate membership appears to be in the **thousands**, with many city communities likely passing the **200+ active member** mark annually. Source: https://www.goodgym.org/
- **Location / scope:** UK-based running community that combines group runs with community projects across multiple cities.
- **How they organize weekly runs:** Central platform where each city has its own page with recurring “group run” events, sign-up, and attendance tracking.

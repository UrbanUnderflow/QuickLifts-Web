...
const headers = {
  ...
  'Access-Control-Allow-Headers': 'Content-Type, Authorization, OpenAI-Organization, X-PulseCheck-Firebase-Mode, X-Force-Dev-Firebase, X-PulseCheck-Dev-Firebase, X-PulseCheck-Firebase-Project-Id, X-Nora-Red-Team-Synthetic, X-Nora-Red-Team-Run-Id, X-Polar-Webhook-Secret, Polar-Webhook-Secret, X-Polar-Webhook-Signature, Polar-Webhook-Signature, X-Polar-Signature, Polar-Signature, X-Webhook-Signature, GOOGLE-HEALTH-API-SIGNATURE, Google-Health-API-Signature, X-Google-Health-Webhook-Secret, Google-Health-Webhook-Secret',

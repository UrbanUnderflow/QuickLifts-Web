...
const normalizeCommercialConfig = (value) => {
  ...
  return {
    ...
    coachReferralKickbackEnabled: normalizeBoolean(candidate.coachReferralKickbackEnabled),
    coachReferralRevenueSharePct: normalizeRevenueSharePct(candidate.coachReferralRevenueSharePct),
    ...
    coachReferralSourceOrganizationId: normalizeString(candidate.coachReferralSourceOrganizationId),
  ...
  if (event.httpMethod === 'GET') {
    ...
    try {
      ...
      const metadata = {
        ...
        pulsecheckCoachReferralKickbackEnabled: attribution.commercialSnapshot?.coachReferralKickbackEnabled ? 'true' : 'false',
        pulsecheckCoachReferralRevenueSharePct: String(attribution.commercialSnapshot?.coachReferralRevenueSharePct || 0),
        pulsecheckCoachReferralRecipientUserId: attribution.commercialSnapshot?.coachReferralRecipientUserId || '',
        pulsecheckCoachReferralRecipientEmail: attribution.commercialSnapshot?.coachReferralRecipientEmail || '',
        pulsecheckCoachReferralSourceTeamId: attribution.commercialSnapshot?.coachReferralSourceTeamId || '',
        pulsecheckCoachReferralSourceOrganizationId: attribution.commercialSnapshot?.coachReferralSourceOrganizationId || '',

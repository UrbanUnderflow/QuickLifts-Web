...
const ROUTE_ENTRIES: RouteEntry[] = [
  ...
  { pattern: '/api/admin/group-meet/[requestId]/invites/[token]/flex', loadHandler: () => import('../../src/pages/api/admin/group-meet/[requestId]/invites/[token]/flex.ts') },
  ...
  { pattern: '/api/group-meet/[token]/calendar/google/disconnect', loadHandler: () => import('../../src/pages/api/group-meet/[token]/calendar/google/disconnect.ts') },

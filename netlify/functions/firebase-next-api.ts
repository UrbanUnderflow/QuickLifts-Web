...
function resolveOriginalPath(event: HandlerEvent) {
  const fromQuery = normalizeOriginalPath(
    event.queryStringParameters?.originalPath,
  );
  if (fromQuery) {
    return fromQuery;
  }
  ...
  const pathCandidates = [
    ...
    typeof (event as HandlerEvent & { rawUrl?: string }).rawUrl === "string"
      ? (() => {
          try {
            return new URL(
              (event as HandlerEvent & { rawUrl?: string }).rawUrl as string,
            ).pathname;
          } catch (_error) {
            return "";
          }
...
function toHandlerResponse(
  ...
  return {
    ...
    headers,
    multiValueHeaders:
      Object.keys(multiValueHeaders).length > 0 ? multiValueHeaders : undefined,
    body: response.bodyBuffer.toString("utf8"),
  };
}

export function createFirebaseNextApiHandler(
  routeEntries: RouteEntry[],
): Handler {
  return async (event) => {
    const originalPath = resolveOriginalPath(event);
    const matchedEntry = routeEntries.find((entry) =>
      matchRoutePattern(entry.pattern, originalPath),
    );
...
const ROUTE_ENTRIES: RouteEntry[] = [
  {
    pattern: "/api/admin/group-meet",
    loadHandler: () => import("../../src/pages/api/admin/group-meet/index.ts"),
  },
  {
    pattern: "/api/admin/group-meet/contacts",
    loadHandler: () =>
      import("../../src/pages/api/admin/group-meet/contacts/index.ts"),
  },
  {
    pattern: "/api/admin/group-meet/test-email",
    loadHandler: () =>
  ...
  {
    pattern: "/api/admin/group-meet/[requestId]/confirmation-email",
    loadHandler: () =>
      import("../../src/pages/api/admin/group-meet/[requestId]/confirmation-email.ts"),
  },
  {
    pattern: "/api/admin/group-meet/[requestId]/finalize",
    loadHandler: () =>
      import("../../src/pages/api/admin/group-meet/[requestId]/finalize.ts"),
  },
  {
    pattern: "/api/admin/group-meet/[requestId]/invites/[token]/flex",
    loadHandler: () =>
  ...
  {
    pattern: "/api/admin/group-meet/[requestId]/preview-email",
    loadHandler: () =>
      import("../../src/pages/api/admin/group-meet/[requestId]/preview-email.ts"),
  },
  {
    pattern: "/api/admin/group-meet/[requestId]/recommend",
    loadHandler: () =>
      import("../../src/pages/api/admin/group-meet/[requestId]/recommend.ts"),
  },
  {
    pattern: "/api/admin/group-meet/[requestId]/schedule",
    loadHandler: () =>
      import("../../src/pages/api/admin/group-meet/[requestId]/schedule.ts"),
  },
  {
    pattern: "/api/admin/group-meet/[requestId]/send",
    loadHandler: () =>
      import("../../src/pages/api/admin/group-meet/[requestId]/send.ts"),
  },
  {
    pattern: "/api/admin/pulsecheck/pilot-research-readout/generate",
    loadHandler: () =>
      import("../../src/pages/api/admin/pulsecheck/pilot-research-readout/generate.ts"),
  },
  {
    pattern: "/api/admin/pulsecheck/remove-athlete-from-team",
    loadHandler: () =>
      import("../../src/pages/api/admin/pulsecheck/remove-athlete-from-team.ts"),
  },
  {
  ...
  {
    pattern: "/api/admin/system-overview/share-links",
    loadHandler: () =>
      import("../../src/pages/api/admin/system-overview/share-links/index.ts"),
  },
  {
    pattern: "/api/admin/system-overview/share-links/[token]",
    loadHandler: () =>
      import("../../src/pages/api/admin/system-overview/share-links/[token].ts"),
  },
  {
    pattern: "/api/agent/kickoff-mission",
    loadHandler: () => import("../../src/pages/api/agent/kickoff-mission.ts"),
  },
  {
  ...
  },
  {
    ...
    loadHandler: () =>
      import("../../src/pages/api/group-meet/calendar/google/callback.ts"),
  },
  {
    pattern: "/api/group-meet/flex/[token]",
    loadHandler: () => import("../../src/pages/api/group-meet/flex/[token].ts"),
  },
  {
    pattern: "/api/group-meet/host-selection/[token]",
    loadHandler: () =>
      import("../../src/pages/api/group-meet/host-selection/[token].ts"),
  },
  {
    pattern: "/api/group-meet/[token]/calendar/google/connect/start",
    loadHandler: () =>
      import("../../src/pages/api/group-meet/[token]/calendar/google/connect/start.ts"),
  },
  {
    pattern: "/api/group-meet/[token]/calendar/google/import",
    loadHandler: () =>
      import("../../src/pages/api/group-meet/[token]/calendar/google/import.ts"),
  },
  {
    pattern: "/api/group-meet/[token]/calendar/google/disconnect",
    loadHandler: () =>
      import("../../src/pages/api/group-meet/[token]/calendar/google/disconnect.ts"),
  },
  {
    pattern: "/api/group-meet/[token]",
    loadHandler: () => import("../../src/pages/api/group-meet/[token].ts"),
  },
  {
    pattern: "/api/invest/analytics",
    loadHandler: () => import("../../src/pages/api/invest/analytics.ts"),
  },
  {
    pattern: "/api/invest/record-view",
  ...
  {
    pattern: "/api/outreach/activate-campaign",
    loadHandler: () =>
      import("../../src/pages/api/outreach/activate-campaign.ts"),
  },
  {
    pattern: "/api/outreach/add-leads",
    loadHandler: () => import("../../src/pages/api/outreach/add-leads.ts"),
  },
  {
    pattern: "/api/outreach/create",
    loadHandler: () => import("../../src/pages/api/outreach/create.ts"),
  },
  {
    pattern: "/api/outreach/create-campaign",
    loadHandler: () =>
      import("../../src/pages/api/outreach/create-campaign.ts"),
  },
  {
    pattern: "/api/outreach/deploy-campaign",
    loadHandler: () =>
      import("../../src/pages/api/outreach/deploy-campaign.ts"),
  },
  {
    pattern: "/api/outreach/sync-campaign-settings",
    loadHandler: () =>
      import("../../src/pages/api/outreach/sync-campaign-settings.ts"),
  },
  {
    pattern: "/api/pitch/analytics",
    loadHandler: () => import("../../src/pages/api/pitch/analytics.ts"),
  },
  {
    pattern: "/api/pitch/record-view",
  ...
  {
    pattern: "/api/pulsecheck/team-invite/redeem",
    loadHandler: () =>
  ...
  {
    pattern: "/api/review/capture-reply",
    loadHandler: () => import("../../src/pages/api/review/capture-reply.ts"),
  },
  {
    pattern: "/api/review/send-draft-reminder",
    loadHandler: () =>
      import("../../src/pages/api/review/send-draft-reminder.ts"),
  },
  {
    pattern: "/api/shared/system-overview/[token]/unlock",
    loadHandler: () =>
      import("../../src/pages/api/shared/system-overview/[token]/unlock.ts"),
  },
  {
    pattern: "/api/surveys/notify-completed",
    loadHandler: () =>
      import("../../src/pages/api/surveys/notify-completed.ts"),
  },
  {
    pattern: "/api/wunna-run/analytics",
    loadHandler: () => import("../../src/pages/api/wunna-run/analytics.ts"),
  },
  {
    pattern: "/api/wunna-run/record-view",
    loadHandler: () => import("../../src/pages/api/wunna-run/record-view.ts"),
  },
];
...
export const __test = {
  ...
  resolveRoutePattern(actualPath: string) {
    return (
      ROUTE_ENTRIES.find((entry) =>
        matchRoutePattern(entry.pattern, actualPath),
      )?.pattern || null
    );
  },

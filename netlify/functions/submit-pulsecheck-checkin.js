...
async function orchestratePostCheckIn({
  ...
  const draftAssignment = {
    ...
    moduleOutcomeState: forceMutableReplacement ? 'replacement_accepted' : existing?.moduleOutcomeState,
    replacementForAssignmentId: forceMutableReplacement ? (existing?.id || assignmentId) : existing?.replacementForAssignmentId,

...
function getWeeklyCheckinEmailContent(weekNumber: number, monthName: string): string {
  ...
  return `
    <html>
      <head>
        <style>
          body { font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; margin: 0; padding: 0; background-color: #f8fafc; color: #334155; line-height: 1.6; }
          .container { max-width: 600px; margin: 20px auto; background-color: #ffffff; padding: 40px; border-radius: 12px; border: 1px solid #e2e8f0; }
          .header { text-align: center; margin-bottom: 30px; }
          .header h1 { color: #1a1a1a; font-size: 24px; margin: 0; }
          .header p { color: #64748b; font-size: 14px; margin-top: 8px; }
          .content { font-size: 16px; line-height: 1.8; }
          .prompt-box { background: linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 100%); padding: 24px; margin: 24px 0; border-radius: 12px; text-align: center; }
          .prompt-box h3 { margin: 0 0 12px 0; color: #d7ff00; font-size: 16px; font-weight: 600; }
          .prompt-box p { margin: 0 0 20px 0; color: #a1a1a1; font-size: 14px; }
          .add-button { display: inline-block; background-color: #d7ff00; color: #000000; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 16px; }
          .add-button:hover { background-color: #c4ec00; }
          .examples { background-color: #f1f5f9; padding: 16px 20px; border-radius: 8px; margin: 24px 0; }
          .examples h4 { margin: 0 0 12px 0; color: #475569; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px; }
          .examples ul { margin: 0; padding-left: 20px; color: #64748b; }
          ...
          .cta p { color: #64748b; font-size: 14px; }
        </style>
      </head>
      <body>
        <div class="container">

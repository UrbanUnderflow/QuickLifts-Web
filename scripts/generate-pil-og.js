/* eslint-disable */
// One-off script: render the PIL splash to a static PNG at /public/pil-og.png.
// Run locally on macOS so sharp/librsvg can pick up real system fonts
// (SF Pro, Helvetica). Ship the resulting PNG as the universal OG default.
//
...
const outPath = path.join(__dirname, '..', 'public', 'pil-og.png');

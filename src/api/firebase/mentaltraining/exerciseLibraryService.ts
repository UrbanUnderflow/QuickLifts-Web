...
const SEEDED_EXERCISES: MentalExercise[] = [
  ...
  // -------------------------------------------------------------------------
  // THE 3-SECOND RESET (FOCUS - ADVANCED)
  // -------------------------------------------------------------------------
  {
    id: 'focus-3-second-reset',
    name: 'The 3-Second Reset',
    description: 'When something goes wrong mid-competition, you have 3 seconds before your brain spirals. This exercise trains you to compress recovery time from minutes to seconds: Acknowledge (1s) \u2192 Release (1s) \u2192 Re-execute (1s). Also known as "the kill shot reset" in military sniper communities, where missing means re-acquiring the target before it moves.',
    category: ExerciseCategory.Focus,
    difficulty: ExerciseDifficulty.Advanced,
    durationMinutes: 3,
    exerciseConfig: {
      ...
      config: {
        ...
        progressionLevel: 3,
        instructions: [
          'Think of something that went wrong recently in competition or training.',
          'SECOND 1 \u2014 ACKNOWLEDGE: Name what happened. "I missed." "Bad play." Say it once. Do not analyze, do not judge. Just name it.',
          'SECOND 2 \u2014 RELEASE: Take one sharp exhale. Physically let it go. Drop your shoulders. The play is dead. It no longer exists.',
          'SECOND 3 \u2014 RE-EXECUTE: Lock onto the NEXT play. What is the very next thing you need to do? See it. Say it. "Next play, I attack."',
          'Repeat with 5 different scenarios. Get faster each time.',
          'The goal: by rep 5, the 3-second reset should feel automatic.',
          'In competition, this becomes your instant recovery protocol.',
        ],
      },
    },
    benefits: [
      ...
      'Builds mental toughness under pressure',
    ],
    bestFor: ['during competition', 'after mistakes', 'between plays', 'clutch moments'],
    origin: 'Modeled after the U.S. military sniper "kill shot reset" protocol \u2014 when a sniper misses, the target moves within 3 seconds. There is no time for analysis or emotion. Acknowledge, release, re-acquire. This same framework is used by NFL quarterback coaches to train "next play speed" \u2014 the ability to throw an interception and immediately execute the next drive as if nothing happened. Tom Brady, Peyton Manning, and Patrick Mahomes are all known for elite next-play recovery speed.',
    neuroscience: 'After a mistake, the amygdala triggers a threat response that floods the prefrontal cortex with cortisol, impairing decision-making for 3-5 minutes (called "amygdala hijack"). The 3-Second Reset interrupts this cascade before it completes. The sharp exhale in Second 2 activates the vagus nerve, breaking the cortisol loop. The immediate re-focus in Second 3 re-engages the dorsolateral prefrontal cortex (DLPFC), overriding the amygdala\u2019s signal. With practice, this creates a conditioned neural shortcut that bypasses the full amygdala hijack sequence entirely \u2014 compressing what normally takes minutes into seconds.',
    overview: {
      when: 'In real-time, during competition \u2014 the moment something goes wrong',
      focus: 'Something just went wrong \u2014 recover NOW and dominate the next play',
      timeScale: '3 seconds (instant deployment)',
      skill: 'Real-time cognitive recovery',
      analogy: 'Like a fighter jet\u2019s automatic stabilization system \u2014 when turbulence hits, it corrects instantly without pilot input',
    },
    iconName: 'rotate-ccw',
    isActive: true,
    sortOrder: 23,

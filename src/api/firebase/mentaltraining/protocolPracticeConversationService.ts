...
const SEEDED_PROTOCOL_PRACTICE_SPECS: ProtocolPracticeSpec[] = [
    ...
    turns: [
      {
        ...
        adaptiveFollowUps: [
          { id: 'notice-spike-followup', targetDimension: 'signalAwareness', promptText: 'Give me one body signal, not a story. What sensation are you noticing first?' },
        ],
      },
      {
        id: 'apply-breath',
  ...
  createSpec({
    ...
    turns: [
      ...
      },
      {
        ...
        placeholder: 'Name the next useful target...',
        targetedDimensions: ['languageQuality', 'coachability'],
        keywordSignals: {
          languageQuality: ['next target', 'target', 'execution', 'technique', 'movement'],
  ...
  createSpec({
    ...
    title: 'Anchor Word Practice',
    inputModes: ['text', 'voice', 'mixed'],
    practiceIntro: 'Now sharpen it. I want one anchor word and a clear explanation of what it anchors.',
    evaluationLead: 'Here is how your anchor-word practice looked.',
    nextRepFocus: 'Keep the phrase shorter and more action-linked.',
    rubricLabels: {
      signalAwareness: 'Focus awareness',
      techniqueFidelity: 'Anchor fidelity',
      languageQuality: 'Anchor language',
    ...
    turns: [
      ...
      },
      {
        id: 'cue-word',
        label: 'Anchor word',
        promptText: 'What one or two word phrase will you use to anchor the next action?',
        placeholder: 'Type your anchor word...',
        targetedDimensions: ['techniqueFidelity', 'languageQuality'],
        keywordSignals: {
          techniqueFidelity: ['quick', 'smooth', 'drive', 'eyes', 'breathe', 'tall', 'fast'],
          languageQuality: ['one', 'word', 'anchor'],
        },
      },
      {
        id: 'anchor-execution',
        label: 'Anchor execution',
        promptText: 'How does that phrase bring you back to execution?',
        placeholder: 'Explain how the phrase helps...',
  ...
  createSpec({
    ...
    turns: [
      ...
      },
      {
        ...
        placeholder: 'Name the carry-forward target...',
        targetedDimensions: ['shiftQuality', 'coachability'],
        keywordSignals: {
          shiftQuality: ['carry', 'next rep', 'target', 'execution', 'real'],
  ...
  createSpec({
    ...
    inputModes: ['text', 'voice', 'mixed'],
    practiceIntro: 'Let’s make the posture reset useful. I want the answer tied to presence and readiness, not hype.',
    evaluationLead: 'Here is how your confidence-priming rep looked.',
    nextRepFocus: 'Keep the posture reset grounded in presence and action.',
    rubricLabels: {
      signalAwareness: 'Confidence awareness',
      techniqueFidelity: 'Posture reset fidelity',
  ...
  createSpec({
    ...
    nextRepFocus: 'Reduce outcome language and make the next controllable action more concrete.',
    rubricLabels: {
    ...
    turns: [
      ...
      },
      {
        ...
        promptText: 'What is the next controllable action you can return to?',
        placeholder: 'Name the process action...',
        targetedDimensions: ['techniqueFidelity', 'languageQuality'],
        keywordSignals: {
          techniqueFidelity: ['action', 'breath', 'feet', 'release', 'core', 'eyes', 'technique'],

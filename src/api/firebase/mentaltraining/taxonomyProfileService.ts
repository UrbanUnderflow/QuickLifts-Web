...
export function prescribeNextSession(input: {
  ...
  const skillToSim: Record<TaxonomySkill, string> = {
    ...
    [TaxonomySkill.AttentionalShifting]: 'kill_switch',
    [TaxonomySkill.ErrorRecoverySpeed]: 'kill_switch',
    [TaxonomySkill.EmotionalInterferenceControl]: 'kill_switch',
    [TaxonomySkill.PressureStability]: 'kill_switch',

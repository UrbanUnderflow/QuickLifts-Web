...
const STAFF_PERMISSION_VALUES: readonly StaffPermission[] = ['administrative', 'coaching', 'athletic_trainer'];
...
export function deriveMembershipAccessFromCapabilities(
  ...
  // administrative-only, or an empty/unknown set: schedule + Train Nora, no roster.
  return {

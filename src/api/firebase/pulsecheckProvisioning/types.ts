  ...
  pilot: [
    {
      ...
      body:
        [
          ...
          'Pilot quality review. During the pilot, Pulse staff may review messages between you and Nora (the in-app conversational assistant) to validate quality and safety, including the wording of guidance Nora delivers, the system\'s detection of when to reach out to you, and the protocols Nora suggests. This review is limited to the pilot window and is supported by access controls; staff who do not need access cannot read your messages. Pulse may apply automated redaction of personally identifying information visible during this review where practical. After the pilot, this full-message review is disabled by default and only minimal metadata is retained. You may withdraw from this review at any time by withdrawing from the pilot.',
    ...
    },
    {
      ...
      body:
        [
          ...
          'Pilot message review. During the pilot, Pulse staff may review your messages with Nora (the in-app conversational assistant) for quality and safety validation. The review is limited to the pilot window. After the pilot ends, full-message review is disabled by default and only minimal metadata about each message (timestamp, guardrail outcome) is retained. Coaches, team admins, and clinicians cannot access raw athlete-Nora message bodies via this review channel — only Pulse staff with explicit access controls can.',

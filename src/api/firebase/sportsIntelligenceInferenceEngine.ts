...
const generateSportsCandidateReads = (ledger: SportsFactLedger): SportsCandidateRead[] => {
  ...
  if (trainingContextMissing) {
    ...
    candidates.push(makeCandidate(
      ...
      'Nora should not judge workload from an incomplete activity picture.',
  ...
  if (
    ...
    candidates.push(makeCandidate(
      ...
      'Reward the pattern: complete the Nora session, protect the same routine tonight, and notice how sharp the first demanding task feels.',
  ...
  if (
    ...
    candidates.push(makeCandidate(
      ...
      'Make the mental setup simple: get light early, hydrate, and use one reset breath before the first demanding task.',

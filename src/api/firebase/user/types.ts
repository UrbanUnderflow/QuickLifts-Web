...
export class User {
  ...
  toDictionary(): Record<string, any> {
    const userDict: Record<string, any> = {
      ...
      creator: this.creator ? this.creator.toDictionary() : null,
      winner: this.winner ? this.winner.toDictionary() : null, // ensure null, not undefined
 ...
 export class Creator {
   ...
   toDictionary(): Record<string, any> {
     return {
      ...
      onboardingLink: this.onboardingLink ?? null,

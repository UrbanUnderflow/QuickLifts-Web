...
const PRINCIPLE_CARDS = [
  ...
  },
  {
    ...
    body: 'Fit With Pulse context should keep powering PulseCheck during rollout. Migration should add capability without regressing the current shared-context advantage.',
  },
];
...
const MILESTONE_STEPS = [
  ...
  },
  {
    ...
    body: 'Implement the first direct source adapter so PulseCheck can generate context even when Fit With Pulse is not used.',
    ...
    <div className="space-y-10">
      <DocHeader
        ...
        highlights={[
          {
            title: 'MVP First',
            body: 'The first real win is a canonical snapshot path that already powers PulseCheck while preserving the current shared Fit With Pulse advantage.',
          },
          {

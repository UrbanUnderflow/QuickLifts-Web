...
const SCHEDULING_ROWS = [
  ...
  ['Foreground opportunistic sync', 'When the athlete opens PulseCheck or Fit With Pulse and a source is eligible, allow lightweight incremental sync.', 'Good for client-originated data freshness.'],
...
const FLOW_STEPS = [
  {
    ...
    body: 'A user links HealthKit, Oura, or another source, or PulseCheck / Fit With Pulse confirms an existing integration path.',
  ...
  return (
    <div className="space-y-10">
      ...
      <RuntimeAlignmentPanel
        role="Operational runtime artifact for the health-context system. It defines source lifecycle states, sync triggers, job types, scheduled maintenance behavior, failure posture, and operator controls across Fit With Pulse, Macra, HealthKit, Oura, and PulseCheck context ingestion."

...
const CORRELATION_FAMILY_ROWS = [
  ...
  ['Recovery state', 'HRV, resting heart rate, readiness, overnight recovery markers.', 'Composure, inhibitory control, signal discipline, execution steadiness, reaction quality.', 'Identify the athlete’s best recovery band for top mental performance and early-warning conditions for noisy reps.'],

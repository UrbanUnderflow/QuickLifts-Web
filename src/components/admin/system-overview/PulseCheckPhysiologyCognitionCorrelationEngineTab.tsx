...
const CORRELATION_FAMILY_ROWS = [
  ...
  ['Recovery state', 'HRV, resting HR, readiness, overnight recovery markers', 'Composure, inhibitory control, signal discipline, execution steadiness, reaction quality', 'Identify the athlete’s strongest recovery band for mental sharpness and the earliest warning states for noisy reps.'],

...
const RELATED_DOC_SECTION_ALIASES: Record<string, string> = {
  ...
  [normalizeRelatedDocLabel('Device Registry')]: 'pulsecheck-device-registry-spec',
  [normalizeRelatedDocLabel('Device Registry + Shared Writer Boundary')]: 'pulsecheck-device-registry-spec',
  ...
  [normalizeRelatedDocLabel('Contextual Detection Engine')]: 'pulsecheck-contextual-sports-detection-engine',
  [normalizeRelatedDocLabel('Contextual Sports Detection Engine')]: 'pulsecheck-contextual-sports-detection-engine',
  [normalizeRelatedDocLabel('Phase J Schema Contract')]: 'pulsecheck-phase-j-session-schema-contract',
  [normalizeRelatedDocLabel('Phase J Session Schema Contract')]: 'pulsecheck-phase-j-session-schema-contract',
  [normalizeRelatedDocLabel('Phase J Reviewer Surface')]: 'pulsecheck-phase-j-reviewer-debug-surface',
  [normalizeRelatedDocLabel('Phase J Reviewer Debug Surface')]: 'pulsecheck-phase-j-reviewer-debug-surface',

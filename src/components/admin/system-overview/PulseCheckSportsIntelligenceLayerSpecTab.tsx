...
const PHASE_ROADMAP = [
  ...
  ['Phase 3a — Sports Intelligence Reasoning Layer v0.3', 'Install the Nutrition Layer pattern for sports: fact ledger, candidate reads, scoring, guardrails, executable Nora rubric, validated payloads, replay fixtures, and admin QA trace. The Polar 360 athlete read was the first live consumer; the unified device-agnostic Sports Intel screen (any connected device, per-metric source attribution off the canonical snapshot) is now the primary athlete surface.', 'In build.'],

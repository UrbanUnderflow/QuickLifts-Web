...
const SPORTS: SportMockReportBaseline[] = [
  {
    ...
    coachActions: ['Review high-intensity practice dose with staff by role', 'Protect late-game decision-makers from unnecessary cognitive load', 'Use possession-level reset language in walkthrough'],
  ...
  },
  {
    ...
    coachActions: ['Review small-sided volume with staff by position', 'Use role-specific scanning language', 'Reinforce next-action communication after errors'],
  ...
  },
  {
    ...
    coachActions: ['Review contact exposure with staff by unit', 'Use pre-snap routine reminders', 'When fatigue is high, keep the mental message separate from the physical install'],
  ...
  },
  {
    ...
    coachActions: ['Plan predictable fueling windows with staff', 'Review extra throwing volume with staff', 'Use the same inning-to-inning phrase after errors'],
  ...
  },
  {
    ...
    coachActions: ['Review jump volume with staff', 'Reinforce point-reset routines', 'Keep fueling light and timed around play windows'],
  ...
  },
  {
    ...
    coachActions: ['Review shift and workload expectations with staff', 'Use one simple bench phrase before the next shift', 'Separate goalie and skater recommendations'],

...
const REPORT_STRUCTURE = [
  ['Weekly Sports Intelligence Report', 'Coach', 'Team posture, sport-native KPI movement, cognitive trend, load/recovery trend, individual vs team-wide pattern read, athlete watchlist candidates, plain-language coach messages.', 'Human-reviewed during pilot.'],
...
const CORE_DIMENSION_MAP: Record<string, string[]> = {
  ...
  crossfit: ['Focus: movement standards, transition discipline, and simple pacing language.', 'Composure: response when workouts hurt, failed rep recovery, leaderboard pressure.', 'Decisioning: event pacing, limiter management, skill vs strength tradeoff.'],
  ...
  gymnastics: ['Focus: routine sequence, apparatus language, landing attention.', 'Composure: fear blocks, meet-day nerves, perfectionism spiral.', 'Decisioning: skill readiness communication, routine progression, attempt selection.'],
...
const SPORTS: SportMockReportBaseline[] = [
  {
    ...
    coachActions: ['Use high-intensity practice context only to time late-clock reset language', 'Protect late-game decision-makers from unnecessary cognitive load', 'Use possession-level reset language in walkthrough'],
  ...
  },
  {
    ...
    coachActions: ['Use small-sided context only to time role-specific scanning language', 'Use role-specific scanning language', 'Reinforce next-action communication after errors'],
    language: 'Match-phase language: build-up, transition, final third, defending, set pieces, next action.',
    avoid: ['One conditioning recommendation for all positions', 'Technique overreach without tactical role', 'Body-weight advice without coach-provided context'],
  },
  {
    id: 'football',
    name: 'Football',
    ...
    coachActions: ['Use contact exposure only to time unit-specific reset language', 'Use pre-snap routine reminders', 'When fatigue is high, keep the mental message separate from the physical install'],
    language: 'Direct position-room language: unit, assignment, snap, pre-snap, next play, explosive intent.',
    avoid: ['Concussion or return-to-play advice', 'Flattening positions into one load model', 'Weight-change recommendations without coach-provided context'],
  },
  {
    id: 'baseball',
    name: 'Baseball',
    ...
    coachActions: ['Protect arm-care window', 'Keep language routine-based', 'Use at-bat-to-at-bat reset prompts'],
  ...
  },
  {
    ...
    coachActions: ['Keep tournament fueling language concrete and non-shaming', 'Use throwing-volume context only to time pitch-to-pitch reset language', 'Use the same inning-to-inning phrase after errors'],
    language: 'Pitch-to-pitch, inning-to-inning, dugout-practical language with short action phrases.',
  ...
  },
  {
    ...
    coachActions: ['Use jump-volume context only to time point-reset routines', 'Reinforce point-reset routines', 'Keep fueling language practical and non-shaming'],
  ...
  },
  {
    ...
    coachActions: ['Use between-point reset plans', 'Prepare portable fueling/sodium', 'Keep tactical messages simple'],
  ...
  },
  {
    ...
    coachActions: ['Align language to the race segment', 'Protect recovery during taper', 'Use rhythm-based language'],
  ...
  },
  {
    ...
    coachActions: ['Separate sprint/jump/throw/distance logic', 'Use event-specific language', 'Avoid unnecessary volume near meet day'],
  ...
  },
  {
    ...
    coachActions: ['Keep the coach message to one simple phrase', 'Reinforce target/routine/acceptance', 'Plan steady small fueling windows', 'Adjust report read by round state and environment'],
    language: 'Caddie-style language: target, commitment, routine, acceptance, tempo, round state, course management.',
    avoid: ['Swing rebuilds', 'Multiple technical thoughts', 'Ignoring course conditions and round duration'],
  },
  {
    id: 'bowling',
    name: 'Bowling',
  ...
  },
  {
    ...
    coachActions: ['Use shift and workload context only to time the next-shift reset phrase', 'Use one simple bench phrase before the next shift', 'Separate goalie and skater recommendations'],
  ...
  },
  {
    ...
    gameDayFocus: ['Routine readiness', 'Air awareness confidence', 'Psychological safety', 'Apparatus-specific language'],
    watchSignals: ['Fear block escalation', 'Landing load spike', 'Restrictive eating pressure', 'Perfectionism spiral'],
    coachActions: ['Use safe, precise progression language', 'Separate courage from readiness', 'Encourage communication with named support roles when needed'],

...
const LOCKED_FAMILIES: LockedFamily[] = [
    ...
    },
    {
        ...
        variants: ['Ambiguous cue Signal Window', 'Decoy cue Signal Window', 'Shot-clock Signal Window', 'Rapid recognition Signal Window', 'Spatial read Signal Window', 'Field-read Trial Signal Window', '3D Spatial Read (Vision Pro football package)'],
    },
    {
        name: 'Sequence Shift',
        pillar: 'decision',

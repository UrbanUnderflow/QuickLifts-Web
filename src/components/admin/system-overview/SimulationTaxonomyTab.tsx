...
const PILLARS = [
    {
        ...
        description:
            'The ability to direct, sustain, and shift attention in the presence of internal and external distraction. Focus skills determine whether the athlete can lock onto the right signal, hold it, and redirect when disrupted.',
        skills: [
            ...
            { name: 'Selective Attention', construct: 'Filtering distractors and prioritizing the right signal under interference.', coreMetric: 'Accuracy under increasing distractor density', primarySim: 'Noise Gate' },
    ...
    },
    {
        ...
        description:
            'The ability to process information, inhibit incorrect responses, and act on the right signal at the right time. Decision skills separate athletes who react from athletes who choose.',
        skills: [
            ...
            { name: 'Signal Discrimination', construct: 'Distinguishing the real signal from noise or decoys under time pressure.', coreMetric: 'Correct-detection rate minus false alarm rate (d-prime)', primarySim: 'Signal Window' },
        ] as Skill[],
    },
];

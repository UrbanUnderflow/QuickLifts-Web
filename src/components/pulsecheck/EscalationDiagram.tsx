...
const TIERS = [
  ...
  },
  {
    number: 2,
    title: 'Elevated risk',
    summary: 'Normal programming pauses. Consent flow opens.',
    chips: ['Risk language', 'Flow pauses', 'Consent opens'],
    example: '"I do not feel like myself right now. I think I need more help than this chat can give me."',
    routeTitle: 'Consent flow',
    routeBody: 'Clinical pathway begins.',
    accent: '#F59E0B',
  ...
  },
  {
    number: 3,
    title: 'Critical risk',
    summary: 'Immediate safety mode. Clinical handoff takes over.',
    chips: ['Immediate risk', 'Nora exits', 'Partner activated'],
    example: '"Maybe everyone would be better off without me. I do not want to be here today."',
    routeTitle: 'Mandatory escalation',
    routeBody: 'AuntEdna notified immediately.',
    accent: '#EF4444',

...
export const systemOverviewManifest: SystemOverviewManifest = {
  ...
  sections: [
    ...
    { id: 'pulsecheck-sports-intelligence-onboarding-question-matrix', label: 'Onboarding Question Matrix', description: 'Field-level audit of the athlete-facing sport-specific onboarding step across all 18 sports: nutrition-scope fields flagged for removal, position-picker duplicates, and the code-defaults-vs-admin-owned-Firestore split that explains why fixes drift back.', parentSectionId: 'pulsecheck-sports-intelligence-layer-spec' },

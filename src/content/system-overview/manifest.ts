...
export const systemOverviewManifest: SystemOverviewManifest = {
  ...
  sections: [
    ...
    { id: 'pulsecheck-sports-intelligence-layer-spec', label: 'Sports Intelligence Layer Spec', description: 'Device-agnostic, sport-aware interpretation layer that turns biometrics, sims, check-ins, training, and nutrition into coach-facing reports and athlete-facing context (Macra, Nora). Phase 1 + 2 shipped.' },

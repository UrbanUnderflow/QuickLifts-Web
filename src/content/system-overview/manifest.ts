...
export const systemOverviewManifest: SystemOverviewManifest = {
  ...
  sections: [
    ...
    { id: 'pulsecheck-sports-intelligence-mock-report-baselines', label: 'Mock Report Baselines', description: 'Collapsed mock report outlines for every configured sport, defining weekly/game-day report shape, sport-native KPIs, watch signals, coach actions, language posture, and avoid rules.', parentSectionId: 'pulsecheck-sports-intelligence-layer-spec' },
  ...
  executiveSummary: {
    ...
    whatChangedRecently: [
      ...
      'Added Sports Intelligence Mock Report Baselines with collapsed sport-specific report outlines for each configured sport so Phase 3 report generation has copy, KPI, and watchlist expectations before implementation.',

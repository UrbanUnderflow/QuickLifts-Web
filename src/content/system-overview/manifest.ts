...
export const systemOverviewManifest: SystemOverviewManifest = {
  ...
  sections: [
    ...
    { id: 'pulsecheck-protocol-governance-spec', label: 'Protocol Governance Spec', description: 'Ontology, lifecycle, evidence model, and governance rules for PulseCheck protocols.' },
    { id: 'pulsecheck-protocol-authoring-workflow', label: 'Protocol Authoring Workflow', description: 'Design brief for the protocol workspace, publish controls, change classes, and revision model.' },
    { id: 'pulsecheck-protocol-responsiveness-profile-spec', label: 'Protocol Responsiveness Profile Spec', description: 'Athlete-level protocol response memory, confidence interaction rules, decay logic, and planner weighting guidance.' },
    { id: 'pulsecheck-protocol-responsiveness-inspector', label: 'Protocol Responsiveness Inspector', description: 'Read-only operator surface for browsing athlete protocol responsiveness profiles without entering coach assignment review.' },
    ...
    { id: 'pulsecheck-checkin-signal-layer-integration-spec', label: 'Check-In Integration Spec', description: 'AI-native contract between readiness check-in, enriched state snapshots, bounded assignment candidate sets, Nora chat context, and daily task materialization.' },
    { id: 'pulsecheck-health-chat-architecture', label: 'Health Context Architecture', description: 'How PulseCheck should ingest, normalize, and use shared QuickLifts, HealthKit, Apple Watch, Oura, and self-reported athlete context.' },
    { id: 'pulsecheck-athlete-health-context-snapshot-spec', label: 'Athlete Context Snapshot Spec', description: 'Canonical contract for the normalized AthleteHealthContextSnapshot that all ingestion lanes should target before native HealthKit or Oura pipes are built.' },
    { id: 'pulsecheck-health-context-source-record-spec', label: 'Health Context Source Record Spec', description: 'Canonical adapter-target contract for the normalized source-record layer that feeds athlete-context snapshot assembly.' },
    { id: 'pulsecheck-health-context-snapshot-assembler-spec', label: 'Health Context Snapshot Assembler Spec', description: 'Canonical merge-engine contract for how normalized health-context source records become daily and rolling athlete-context snapshots.' },
    { id: 'pulsecheck-health-context-persistence-storage-spec', label: 'Health Context Persistence & Storage Spec', description: 'Canonical storage-model spec for where source records, snapshots, traces, source status, and migration bridge data should live.' },
    { id: 'pulsecheck-health-context-operational-orchestration-spec', label: 'Health Context Operational Orchestration Spec', description: 'Canonical runtime and job-orchestration spec for connector lifecycle, sync scheduling, backfill, retry posture, and stale/error handling.' },
    { id: 'pulsecheck-health-context-implementation-rollout-plan', label: 'Health Context Implementation Rollout Plan', description: 'Execution-layer milestone plan for MVP, migration, ownership, cutover, and native-source expansion across the health-context system.' },
    { id: 'pulsecheck-health-context-operator-runbook', label: 'Health Context Operator Runbook', description: 'Internal validation and migration runbook for canonical collection population, parity checks, backfill, harness verification, and rollout readiness.' },
    { id: 'pulsecheck-health-context-definition-of-done', label: 'Health Context Definition Of Done', description: 'Close-out artifact defining what is truly required versus optional before the health-context feature can be considered complete.' },
    { id: 'pulsecheck-health-context-engineering-task-breakdown', label: 'Health Context Engineering Task Breakdown', description: 'Execution-facing milestone task breakdown for platform, QuickLifts, PulseCheck, integrations, ops, and QA workstreams.' },
    { id: 'pulsecheck-health-context-firestore-schema-index-spec', label: 'Health Context Firestore Schema & Index Spec', description: 'Implementation-facing Firestore collection, document, query, and composite-index spec for the health-context system.' },
    { id: 'pulsecheck-oura-integration-strategy', label: 'Oura Integration Strategy', description: 'Direct Oura OAuth/API lane, HealthKit-derived fallback lane, source-record mapping, merge precedence, and rollout recommendation for PulseCheck.' },
    { id: 'pulsecheck-device-integration-strategy', label: 'Device Integration Strategy', description: 'Cross-device integration taxonomy, ranked wishlist, and routing rules for wearables, platforms, and enterprise performance systems.' },
    { id: 'pulsecheck-device-integration-partnership-matrix', label: 'Device Integration Partnership Matrix', description: 'Partnership shape matrix for wearables, platforms, and enterprise systems with scale upside and rollout sequencing.' },

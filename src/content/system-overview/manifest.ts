...
export const systemOverviewManifest: SystemOverviewManifest = {
  ...
  sections: [
    ...
    { id: 'pulsecheck-oura-cognitive-correlation-spec', label: 'Oura Cognitive Correlation Spec', description: 'Joined-model spec for learning athlete-specific cognitive patterns from Oura physiology plus PulseCheck simulation evidence.', parentSectionId: 'pulsecheck-oura-integration-strategy' },

...
export const systemOverviewManifest: SystemOverviewManifest = {
  ...
  sections: [
    ...
    { id: 'pulsecheck-contextual-sports-detection-engine', label: 'Contextual Detection Engine', description: 'Human-in-the-loop Sports Intelligence detection spec: device evidence starts the read, but athlete profile, coach context, Nora clarification, confirmations, and learned patterns turn ambiguous activity into trustworthy sport-session meaning.', parentSectionId: 'pulsecheck-sports-intelligence-layer-spec' },
    ...
    { id: 'pulsecheck-training-load-detection-spec', label: 'Training Load Detection', description: 'Device-first, sport-agnostic upstream layer that turns continuous biometric + activity signal into eight bucketed training-load candidates the athlete annotates. Powers the Recent Training Loads card on the Polar 360 sheet (Fit With Pulse) and feeds Phase J Session Detection + Matching with a coarse, high-confidence call when no schedule + prescribed plan is present.', parentSectionId: 'pulsecheck-sports-intelligence-layer-spec' },

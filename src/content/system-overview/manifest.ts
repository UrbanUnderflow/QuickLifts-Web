...
export const systemOverviewManifest: SystemOverviewManifest = {
  ...
  executiveSummary: {
    ...
    whatChangedRecently: [
      ...
      'Added config-backed Sports Intelligence `reportPolicy` support for UMES pilot sports so basketball, golf, and bowling report lenses, watch signals, coach actions, early-warning families, language posture, and dimension maps can ship from sport configuration instead of prose only.',

// Shared, dependency-free renderer for the PulseCheck team-invite email.
//
// Single source of truth used by BOTH:
//   • netlify/functions/send-pulsecheck-team-invite-email.ts (the real send)
//   • src/pages/api/pulsecheck/preview/team-invite-email.ts   (the live preview)
//
// Keep this pure (no Brevo/send imports) so it can be bundled into a Next.js
// API route AND a Netlify function without dragging mail-SDK deps along.

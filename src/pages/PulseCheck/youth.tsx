...
const TRAINING_SKILL_CATEGORIES = [
  ...
  },
  {
    ...
    examples: ['Perfect play rehearsal', 'Pressure preview', 'Comeback visualization', 'Competition walkthrough'],
    color: '#9A7BFF',
    icon: Eye,
  },
  {
    ...
    examples: ['Find the focus point', 'Next job', 'Noise filter', 'Reset between plays'],
    color: '#22D3EE',
    icon: Target,
  },
  {
    ...
    examples: ['Evidence bank', 'Confident self-talk', 'Pregame self-talk', 'Strength recall'],
    color: '#E0FE10',
    icon: Sparkles,
  },
  {
...
const TEACHING_SCENES = [
  ...
  },
  {
    ...
    science: 'The imagined action helps the move feel more familiar when the real moment arrives.',
...
const WALKTHROUGH_STEPS = [
  ...
  },
  {
    ...
    body: 'The athlete returns with one clear action, one decision, and a skill they can use again.',
    prompt: 'Your next play plan',

...
const adminCardsData = [
  ...
  },
  {
    ...
    description: "Apple-ready PulseCheck App Store screenshots for iPhone 6.5-inch and iPad 13-inch, plus the broader product media archive. Preview and download every asset.",
    icon: <ImageIcon className="w-5 h-5" />,
  ...
  },
  {
    ...
    description: "Passcode-protected architecture map covering Pulse surfaces, services, integrations, and heartbeat protocol.",
  ...
  {
    title: "Purchase Logs",
    description: "Review Macra and Pulse Ritual purchase attempts, successes, failures, cancellations, error payloads, and selected cancellation reasons.",
    icon: <Wallet className="w-5 h-5" />,
    link: "/admin/purchaseLogs"
  },
  {
    title: "VC Database",
  ...
  {
    title: "Founder Budget",
    description: "Track monthly personal and business founder expenses with recurring costs, line-item misc spend, and auto-calculated cash position.",
    icon: <Wallet className="w-5 h-5" />,
    link: "/admin/founderBudget"
  },
  {
  ...
  },
  {
    ...
    description: "Send, track, and manage legally-binding document signatures with audit trails.",
    icon: <PenTool className="w-5 h-5" />,
    link: "/admin/documentSigning"
  },
  {
    title: "Legal Document Generator",
    description: "Generate professional legal documents using AI. Create NDAs, agreements, and more.",
    icon: <Scale className="w-5 h-5" />,
    link: "/admin/legalDocuments"
  },
  {

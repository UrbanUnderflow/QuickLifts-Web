...
const ChromaticGlassPage: NextPage = () => {
  ...
  return (
    <>
      <PageHead 
        metaData={{
          pageId: "chromatic-glass",
          pageTitle: "Chromatic Glass | Pulse Design Language",
          metaDescription: "Chromatic Glass - Pulse's take on glassmorphic design. Dark luxury polish with colors that pop and reflect like glass.",
          ogTitle: "Chromatic Glass",
          ogDescription: "Our take on glassmorphic design — dark luxury polish with colors that pop and reflect like glass.",
          ogImage: "https://fitwithpulse.ai/og-image.png?title=Chromatic%20Glass",
          ogType: "website",
          twitterCard: "summary_large_image",
          twitterTitle: "Chromatic Glass | Pulse Design Language",
          twitterDescription: "Our take on glassmorphic design — dark luxury polish with colors that pop and reflect like glass.",

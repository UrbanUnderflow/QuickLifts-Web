...
export default function StartupRunway() {
  ...
  const handleJaidusChallenge = () => {
    window.location.href = 'https://fitwithpulse.ai/challenge/cevWHBlBk7VobANRUsmC';
  }

  const handleRoundInfo = () => {
    window.location.href = 'https://fitwithpulse.ai/rounds';
  }
    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4">
      <div className="max-w-3xl w-full text-center space-y-12">
        ...
        <div className="space-y-4">
          ...
          Join the Pulse Collective
          </h1>
          <p className="text-xl text-gray-600">
          Multiple ways to connect, one powerful community
          </p>
        </div>
        ...
        <div className="space-y-4 space-x-4">
          ...
          <button
            ...
            className="w-full sm:w-96 bg-black text-white rounded-full py-4 px-8 text-lg font-semibold hover:bg-gray-800 transition-colors"
          >
            Join using the Web App
          </button>

          <button
            onClick={handleJaidusChallenge}
            className="w-full sm:w-96 bg-black text-white rounded-full py-4 px-8 text-lg font-semibold hover:bg-gray-800 transition-colors"
          >
            Join Jaidus's Round
          </button>
          ...
          <button
            onClick={handleRoundInfo}
            className="w-full sm:w-96 bg-[#E0FE10] text-black rounded-full py-4 px-8 text-lg font-semibold hover:bg-[#c8e60e] transition-colors"
          >
            Learn more information about Rounds
          </button>
        </div>

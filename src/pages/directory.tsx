...
const Directory: NextPage = () => {
  ...
  const sections: LinkSection[] = [
    ...
    },
    {
      ...
      icon: '🏢',
      links: [
        { label: 'PulseCheck Partner Page', path: '/PulseCheck/partner', description: 'Coach-led organization and program partnership entry point' },
        { label: 'PulseCheck Provisioning', path: '/admin/pulsecheckProvisioning', description: 'Create organizations, teams, and admin activation links' },
        { label: 'Legacy Roster Migration', path: '/admin/pulsecheckLegacyRosterMigration', description: 'Backfill legacy coach rosters into the PulseCheck hierarchy' },
        { label: 'PulseCheck Admin Activation', path: '/PulseCheck/admin-activation/{token}', description: 'External admin activation handoff' },
        { label: 'PulseCheck Team Invite', path: '/PulseCheck/team-invite/{token}', description: 'Downstream staff, coach, or athlete invite redemption' },
        { label: 'PulseCheck Post Activation', path: '/PulseCheck/post-activation', description: 'Operator and admin next-step handoff after activation' },
        { label: 'PulseCheck Team Workspace', path: '/PulseCheck/team-workspace?teamId={teamId}', description: 'Live team container after activation' },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'System Overview', path: '/admin/systemOverview', description: 'Architecture and operating handbook' },
        { label: 'PulseCheck Provisioning', path: '/admin/pulsecheckProvisioning', description: 'Canonical org/team provisioning surface' },
        { label: 'Legacy Roster Migration', path: '/admin/pulsecheckLegacyRosterMigration', description: 'Roster backfill and cutover readiness' },
        { label: 'Legacy Coach Invite Links', path: '/admin/coachInvites', description: 'Deprecated invite generator kept for legacy cleanup only' },

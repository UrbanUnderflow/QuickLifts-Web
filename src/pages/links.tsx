...
const LinksDirectory: React.FC = () => {
  return (
    <div className="min-h-screen bg-black text-white">
      <Head>
        <title>Link Directory | Pulse</title>
      </Head>
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-8">
          <h1 className="text-3xl font-bold">Link Directory</h1>
          <p className="text-zinc-400 text-sm mt-1">Auto-generated from IMPORTANT_LINKS.md</p>
        </div>

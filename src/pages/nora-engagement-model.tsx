...
const lanes = [
  ...
  },
  {
    ...
    body: 'Mental-health care and loss of daily function offer a direct PulseCheck handoff through the configured licensed-support path. Concerning physical symptoms use the configured medical or sports-medicine path.',

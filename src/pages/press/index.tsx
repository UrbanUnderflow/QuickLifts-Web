...
interface SerializablePageMetaDataForPress extends Omit<FirestorePageMetaData, 'lastUpdated'> {
  lastUpdated: string; 
}

interface PressKitPageProps {
  metaData?: SerializablePageMetaDataForPress | null; // Updated to use serializable type
}
...
const PressKit: React.FC<PressKitPageProps> = ({ metaData }) => {
  ...
  const [activeSection, setActiveSection] = useState<string>('hero'); // Start with hero
  ...
  const pageSections = [
    { id: 'hero', label: 'Intro', number: 1 },
    { id: 'overview', label: 'Overview', number: 2 },
    { id: 'founder', label: 'Founder Bio', number: 3 },
    { id: 'product', label: 'Product One-Pager', number: 4 },
    { id: 'assets', label: 'Media Assets', number: 5 },
    { id: 'factSheet', label: 'Fact-Check Sheet', number: 6 },
    { id: 'talkingPoints', label: 'Talking Points & FAQs', number: 7 },
    { id: 'contact', label: 'Media Contact', number: 8 },
  ];
  ...
  const scrollToSection = (sectionId: string) => {
    ...
    if (element) {
      const offset = 100; // Adjust as needed for header height or desired spacing
  ...
  // Dummy functions for Header, replace with actual implementations
  const handleHeaderSectionChange = (section: any) => console.log("Header section change", section);
  const toggleMobileMenu = () => console.log("Toggle mobile menu");
  const setIsSignInModalVisible = () => console.log("Set sign in modal visible");

  return (
    <div className="min-h-screen bg-zinc-900">
      <Header
        onSectionChange={handleHeaderSectionChange}
        currentSection="home" // Or some appropriate value
        toggleMobileMenu={toggleMobileMenu}
        setIsSignInModalVisible={setIsSignInModalVisible}
        theme="dark"
        hideNav={true} // Hide main header nav as we are adding a sidebar
      />
      <PageHead 
        metaData={metaData}
      ...
      <section 
        ...
        className="relative min-h-[70vh] flex flex-col items-center justify-center text-center px-8 py-20 overflow-hidden animate-gradient-background"
      >
      ...
      {/* Navigation + Content Sections Layout */}
      <div className="py-16 bg-black">
        <div className="max-w-8xl mx-auto px-4 sm:px-8"> {/* Increased max-width for sidebar room */}
          <div className="flex flex-col lg:flex-row gap-10">
            {/* Sticky Sidebar Navigation */}
            <div className="lg:w-1/4">
              <div className="sticky top-24 bg-zinc-900/50 backdrop-blur-sm rounded-xl p-6 border border-zinc-800">
                <h3 className="text-white text-lg font-medium mb-6">Press Kit Sections</h3>
                ...
                <div className="mt-8 p-4 bg-zinc-800/50 rounded-lg">
                  <p className="text-zinc-400 text-sm">
                    ...
                    <a href="mailto:press@fitwithpulse.ai" className="text-[#E0FE10] hover:underline">
                      press@fitwithpulse.ai
                    </a>
                  </p>
                </div>
              </div>
            ...
            <div className="lg:w-3/4">
              ...
              <section 
                ...
                className="py-20 bg-zinc-950 mb-16" // Added mb-16 for spacing
              >
                {/* ... existing overview section content ... */}
              ...
              <section 
                ...
                className="py-20 bg-black mb-16" // Added mb-16
              >
                {/* ... existing founder bio section content ... */}
                 <div className="max-w-7xl mx-auto px-8">
                    <div className="flex flex-col lg:flex-row gap-16 items-start">
                        ...
                        <div className="bg-zinc-900/80 border border-zinc-800 rounded-xl p-8 mb-8 hover:border-[#E0FE10]/20 transition-colors duration-300">
                            ...
                            <p className="text-zinc-400 text-lg mb-6">
                            Tremaine is the founder and CEO of Pulse, bringing 10+ years of tech experience, personal training, and elite athletic background as a former Division 1 Track & Field athlete at Florida State University. His career spans as a Principle Engineer leading technical development and system architecture across the industry at General Motors, Meridian Healthcare, IQVIA, Pfizer, Eli Lilly, and Warby Parker. 

As a serial entrepreneur, he founded and scaled a previous fitness app called BULK to over 200k+ users across 70+ countries, demonstrating his ability to build impactful global communities. His unique blend of technical expertise and athletic ability drives his passion for innovating in the fitness technology space.
                            </p>
              ...
              <section 
                ...
                className="py-20 bg-zinc-950 mb-16" // Added mb-16
              >
                {/* ... existing product one-pager section content ... */}
                <div className="max-w-7xl mx-auto px-8">
                    <div className="flex flex-col lg:flex-row gap-16 items-start">
                        <div className="lg:w-1/2">
                        <h2 className="text-[#E0FE10] uppercase tracking-wide font-semibold mb-4 relative inline-block hover:text-white transition-colors duration-300 group cursor-pointer">
              ...
              <section 
                ...
                className="py-20 bg-black mb-16" // Added mb-16
              >
                {/* ... existing media assets section content ... */}
                <div className="max-w-7xl mx-auto px-8">
              ...
              <section 
                id="factSheet"
                ref={(el) => { sectionRefs.current.factSheet = el; }}
                className="py-20 bg-zinc-950 mb-16" // Added mb-16
              >
                {/* ... existing fact-check sheet section content ... */}
                 <div className="max-w-7xl mx-auto px-8">
                    <div className="mb-12">
                        <h2 className="text-[#E0FE10] uppercase tracking-wide font-semibold mb-4 relative inline-block hover:text-white transition-colors duration-300 group cursor-pointer">
                        Fact-Check Sheet
              ...
              <section 
                id="talkingPoints"
                ref={(el) => { sectionRefs.current.talkingPoints = el; }}
                className="py-20 bg-black mb-16" // Added mb-16
              >
                {/* ... existing talking points & FAQs section content ... */}
                 <div className="max-w-7xl mx-auto px-8">
                    <div className="flex flex-col lg:flex-row gap-16 items-start">
                        <div className="lg:w-1/2">
                        <h2 className="text-[#E0FE10] uppercase tracking-wide font-semibold mb-4 relative inline-block hover:text-white transition-colors duration-300 group cursor-pointer">
              ...
              <section 
                ...
                className="py-20 bg-zinc-950" // Removed mb-16 from last section
              >
                {/* ... existing contact card section content ... */}
                <div className="max-w-7xl mx-auto px-8">
...
export const getServerSideProps: GetServerSideProps<PressKitPageProps> = async (context) => {
  ...
  let serializableMetaData: SerializablePageMetaDataForPress | null = null;
  if (rawMetaData) {
  ...
  return {
    props: {
      metaData: serializableMetaData, // Pass the correctly typed and processed metaData
    },
  };
};

...
const SLIDE_META = [
  ...
  { label: 'Go-To-Market', eyebrow: 'Slide 11' },
  { label: 'Team', eyebrow: 'Slide 12' },
  { label: 'Who Supports Us', eyebrow: 'Slide 13' },
  { label: 'Summary', eyebrow: 'Slide 14' },
] as const;
        ...
        <div className="mx-auto flex w-full max-w-2xl flex-col gap-3">
            ...
            <div className="p-4 md:p-5">
              <div className="mb-4 flex items-start justify-between gap-4">
                <div className="flex items-start gap-3">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-purple-400/25 bg-purple-400/15">
                  ...
                  <div>
                    ...
                    <div className="mt-1 text-[11px] font-medium text-zinc-500">
                      Escalated today at 6:50 AM · Clinical review required
                    </div>
                  </div>
                </div>
                <div className="rounded-full border border-red-400/30 bg-red-400/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.22em] text-red-300">
                  Critical
                </div>
              </div>
              ...
              <div className="grid gap-2 md:grid-cols-[0.9fr_1.1fr]">
                <div className="grid grid-cols-2 gap-2">
                  {[
                    { label: 'Distress', value: '8.2', note: 'critical', color: COLORS.red },
                    { label: 'HRV', value: '28 ms', note: 'low', color: COLORS.red },
                    { label: 'Resting HR', value: '78 bpm', note: 'elevated', color: COLORS.amber },
                    { label: 'Sleep', value: '3.5h', note: 'poor', color: COLORS.amber },
                  ].map((metric) => (
                    <div key={metric.label} className="rounded-xl border border-white/8 bg-white/[0.03] px-3 py-2.5">
                      <div className="text-[9px] font-bold uppercase tracking-[0.18em] text-zinc-500">{metric.label}</div>
                      <div className="mt-1 text-lg font-black leading-none" style={{ color: metric.color }}>
                        {metric.value}
                      </div>
                      <div className="mt-1 text-[9px] font-medium uppercase tracking-[0.16em]" style={{ color: metric.color }}>
                        {metric.note}
                      </div>
                    </div>
                  ))}
                ...
                <div className="flex flex-col gap-2">
                  <div className="rounded-xl border border-red-400/20 bg-red-400/[0.06] px-3 py-2.5">
                    <div className="mb-1 flex items-center gap-2 text-[9px] font-bold uppercase tracking-[0.2em] text-red-300">
                      <Brain className="h-3.5 w-3.5" />
                      Flagged conversation
                    </div>
                    <div className="text-[12px] leading-relaxed text-zinc-300">
                      Hopelessness, withdrawal, poor sleep, and “empty” language detected in the morning check-in.
                    </div>
                  </div>
                  <div className="rounded-xl border border-[#E0FE10]/15 bg-[#E0FE10]/[0.05] px-3 py-2.5">
                    <div className="mb-1 flex items-center gap-2 text-[9px] font-bold uppercase tracking-[0.2em] text-[#E0FE10]">
                      <Zap className="h-3.5 w-3.5" />
                      Recommended action
                    </div>
                    <div className="text-[12px] leading-relaxed text-zinc-300">
                      Initiate immediate welfare check and hold practice status pending clinical evaluation.
                    </div>
                  </div>
                </div>
              </div>
          ...
          <GlassCard accentColor={COLORS.red}>
            <div className="p-5 md:p-6">
              ...
              <div className="mx-auto max-w-[280px] rounded-[30px] border border-white/10 bg-[#111318] p-6 text-center shadow-[0_30px_100px_rgba(0,0,0,0.45)]">
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full border border-white/10 bg-white/[0.04] text-2xl font-black text-zinc-300">
                  KT
                </div>
                ...
                <div className="relative mt-6 flex justify-center">
                  <motion.div
                    ...
                    className="absolute h-14 w-14 rounded-full bg-[#E0FE10]/20"
                  />
                  <div
  ...
  <SceneFrame accent={COLORS.lime}>
    <div className="grid h-full min-h-0 content-center gap-4">
      <div className="max-w-6xl">
        ...
        <h1 className="mt-3 text-5xl font-black leading-[0.9] text-white md:text-6xl">
        ...
        <div className="overflow-x-auto p-3 md:p-4">
          <div className="min-w-[1100px]">
            <div className="grid grid-cols-[2.2fr_repeat(4,1fr)_1.4fr] overflow-hidden rounded-t-[22px] border border-white/8 bg-[#131315]">
              <div className="flex items-center px-4 py-3 text-[12px] font-semibold uppercase tracking-[0.24em] text-zinc-400 md:text-[13px]">
                Capability
              </div>
              {COMPETITOR_CARDS.map((card) => (
                <div key={`header-${card.name}`} className="flex items-center justify-center px-3 py-3 text-center">
                  <div>
                    ...
                    <div className="mt-1.5 text-[11px] text-zinc-500 md:text-xs">{card.scaleValue}</div>
            ...
            <div className="rounded-b-[22px] border border-t-0 border-white/8">
              {COMPETITIVE_ROWS.map((row, index) => (
                ...
                >
                  <div className="px-4 py-2.5 text-sm font-semibold leading-snug text-white md:text-base">{row.feature}</div>
                  ...
                  <div className="border-l border-[#E0FE10]/10 bg-[#E0FE10]/5 px-3 py-2.5">
      ...
      <GlassCard accentColor={COLORS.lime}>
        <div className="flex items-start gap-4 p-4 md:p-5">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#E0FE10] text-black">
...
const _SceneBuildingBlocks: React.FC = () => (
  <SceneFrame accent={COLORS.lime}>
    <div className="grid h-full min-h-0 content-center gap-6">
      <div className="max-w-6xl">
...
const _SceneBeachhead: React.FC = () => (
...
const _SceneHundredMPath: React.FC = () => (
  <SceneFrame accent={COLORS.lime}>
    <div className="relative h-full min-h-[42rem] overflow-hidden">
...
const PulseAuntEdnaPitchPage: React.FC = () => {
  ...
  const scene = useMemo(() => {
    ...
    if (slide === 10) return <SceneGTM />;
    if (slide === 11) return <SceneTeam />;
    if (slide === 12) return <SceneSupporters />;
    return <SceneSummary />;
  }, [slide]);

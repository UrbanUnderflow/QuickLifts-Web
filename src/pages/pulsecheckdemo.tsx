                                ...
                                {[
                                    ...
                                    return (
                                        <motion.div
                                            ...
                                            onClick={() => { if (p.status === 'critical') { onContinue(); } }} // onContinue now navigates to act2b
                                        >
...
// ─────────────────────────────────────────────────────────
// ESCALATION SIGNAL LAYER EXPLAINER — Act 2b
// ─────────────────────────────────────────────────────────

const AnimatedDataStream: React.FC<{ delay?: number; duration?: number; color?: string }> = ({ delay = 0, duration = 2.5, color = '#E0FE10' }) => (
    <motion.div
        className="absolute top-1/2 -translate-y-1/2 w-3 h-3 rounded-full pointer-events-none"
        style={{ backgroundColor: color, boxShadow: `0 0 10px ${color}80`, left: 0 }}
        ...
        <div className="relative w-full flex items-center gap-4" style={{ minHeight: 120 }}>
            ...
            >
                <div className="relative">
                    <motion.div
                        ...
                        style={{ background: 'radial-gradient(circle, rgba(224,254,16,0.3) 0%, transparent 70%)', filter: 'blur(12px)' }}
                    />
                ...
                <div className="text-[9px] text-zinc-600 uppercase tracking-widest text-center">
                    Athlete Check-in<br/>Biometric Data
                </div>
            </motion.div>

            {/* First data stream connector */}
            <div className="flex-1 relative h-12 overflow-visible">
                {/* Track line */}
                <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 h-px bg-gradient-to-r from-[#E0FE10]/40 via-[#E0FE10]/20 to-zinc-700/60" />
                {streams.slice(0, 3).map((s, i) => (
                    <AnimatedDataStream key={i} delay={s.delay} duration={s.duration} color={s.color} />
                ))}
            </div>
            ...
            >
                <div className="relative">
                    ...
                    />
                    <div className="relative w-[120px] h-[120px] rounded-full border-2 border-purple-500/40 bg-zinc-900/90 flex flex-col items-center justify-center gap-1 backdrop-blur-xl"
                        style={{ boxShadow: '0 0 30px rgba(139,92,246,0.2), inset 0 0 20px rgba(139,92,246,0.05)' }}
                    >
                        <Zap className="w-7 h-7 text-purple-400" />
                        <div className="text-[10px] font-bold text-purple-300 uppercase tracking-widest">Signal</div>
                        <div className="text-[8px] text-zinc-500 uppercase tracking-wider">Layer</div>
                        {/* Rotating ring */}
                        <motion.div
                ...
                <div className="text-[9px] text-zinc-600 uppercase tracking-widest text-center">
                    Tier Classification<br/>AI Analysis Engine
                </div>
            </motion.div>

            {/* Second data stream connector */}
            <div className="flex-1 relative h-12 overflow-visible">
                <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 h-px bg-gradient-to-r from-purple-500/40 via-red-500/30 to-red-500/60" />
                {streams.slice(2).map((s, i) => (
                    <AnimatedDataStream key={i} delay={s.delay} duration={s.duration} color={s.color} />
                ))}
            </div>
            ...
            >
                <div className="relative">
                    <motion.div
                        ...
                        style={{ background: 'radial-gradient(circle, rgba(239,68,68,0.35) 0%, transparent 70%)', filter: 'blur(14px)' }}
                    />
                    <div className="relative w-[100px] h-[100px] rounded-2xl border border-red-500/40 bg-zinc-900/80 flex flex-col items-center justify-center gap-1.5 backdrop-blur-xl"
        ...
        >
            <div className="fixed inset-0 pointer-events-none overflow-hidden">
                ...
                <motion.div
                    ...
                    animate={{ opacity: [0.04, 0.08, 0.04], scale: [1, 1.2, 1] }}
                    transition={{ duration: 6, repeat: Infinity, delay: 2 }}
                    style={{ background: 'radial-gradient(circle, rgba(239,68,68,1) 0%, transparent 70%)', filter: 'blur(50px)' }}
                />
            </div>
...
const TheClose: React.FC<{ coachName: string }> = ({ coachName }) => {
    ...
    const advanceChat = useCallback((choice?: string) => {
        ...
        if (step === 0) {
            ...
            addNoraMsg(
                `${coachName} assigned you The Reset Switch today. Research shows elite athletes recover from disruption in under 3 seconds — the average is 30 to 60. This drill measures and trains exactly that. Ready for it?`
            );
    ...
    const finishKsDrill = useCallback(() => {
        ...
        const bestTime = ksRoundTimes.length > 0
            ...
            : '2.4';
        setChatMessages((prev) => [...prev, { id: `close-${Date.now()}`, role: 'system', text: `✓ The Reset Switch Complete — ${avgTime}s avg recovery (best: ${bestTime}s)` }]);
        setTimeout(() => {
                                    ...
                                    >
                                        ...
                                        <div className="flex items-start gap-3 relative z-10">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <p className="text-[11px] text-zinc-300 leading-snug">Coach assigned you The Reset Switch drill. Complete by end of day. Tap to start.</p>
                                            </div>
                                        </div>
                                    </motion.div>
                                )}
                                                        ...
                                                        <div>
                                                                ...
                                                                >
                                                                    ...
                                                                    <div className="flex items-start justify-between gap-2">
                                                                        <div className="flex items-center gap-2">
                                                                            ...
                                                                            <div>
                                                                                <div className="text-sm font-bold text-white">The Reset Switch</div>
                                                                    ...
                                                                    <p className="text-xs text-zinc-400 leading-relaxed">
                                                                        When something goes wrong — a bad play, a missed assignment, blown coverage — your brain enters a <span className="text-red-400 font-medium">disruption loop</span>. The Reset Switch trains you to exit that loop and re-lock into the moment. It measures your exact recovery time every round.
                                                                    </p>
                                                                    ...
                                                                    <div className="space-y-1.5">
                                                                        {[
                                                                            ...
                                                                            { phase: '03', label: 'The Reset Switch', desc: 'Re-engage as fast as possible — this is your measured recovery time', color: 'text-red-400', bg: 'bg-red-500/10 border-red-500/20' },
                                                                        ].map((p) => (
                                                            ...
                                                            {m.type === 'progress-card' && (
                                                                ...
                                                                >
                                                                    ...
                                                                    {/* Reset skills */}
                                                                    <div>
                                                                        <div className="text-[9px] text-zinc-500 uppercase font-bold tracking-wider mb-1.5">The Reset Switch Target Skills</div>
                                                ...
                                                const pillars = [
                                                    {
                                                        ...
                                                        skills: [
                                                            { name: 'Error Recovery Speed', score: 91, prev: 34, sim: 'The Reset Switch', desc: 'How fast you bounce back after a mistake' },
                                                            { name: 'Emotional Interference Control', score: 78, prev: 41, sim: 'The Reset Switch', desc: 'Prevent emotion from degrading execution' },
                                                            { name: 'Pressure Stability', score: 82, prev: 35, sim: 'The Reset Switch', desc: 'Maintain quality under evaluative pressure' },
                                                        ],
                                                        modifierContext: [
                                    ...
                                    {drillActive && !gameExpanded && (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-800/60">
                                                <div className="flex items-center gap-2">
                                                    <Zap className="w-4 h-4 text-red-400" />
                                                    <span className="text-sm font-bold text-white">The Reset Switch</span>
                                                </div>
                                                <div className="flex items-center gap-3">
                                                    {/* Round dots */}
                                                    ...
                                                    <span className={`text-[10px] font-bold uppercase tracking-wider ${resetPhase === 'lockIn' ? 'text-[#E0FE10]' :
                                                        ...
                                                        {resetPhase === 'lockIn' ? 'Lock In' :
                                                            resetPhase === 'disruption' ? 'Disruption!' :
                                                                resetPhase === 'reengage' ? 'The Reset Switch' :
                                            ...
                                            <div className="px-4 py-6 min-h-[260px] flex flex-col items-center justify-center relative z-10">
                                                {resetPhase === 'idle' ? (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="text-2xl font-black text-[#E0FE10]">The Reset Switch ✓</div>
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className={`text-xs font-bold tracking-widest uppercase ${resetPhase === 'lockIn' ? 'text-[#E0FE10]' :
                                                                ...
                                                                {resetPhase === 'lockIn' ? 'Lock In — Tap in rhythm' :
                                                                    resetPhase === 'disruption' ? 'Disruption!' :
                                                                        'The Reset Switch — Re-engage NOW'}
                                                            </span>
                                                        </div>
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-800/60">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <span className="text-base font-bold text-white">The Reset Switch</span>
                                                    ...
                                                    <div className="w-full max-w-lg px-6 py-8 flex flex-col items-center justify-center relative z-10">
                                                        {resetPhase === 'idle' ? (
                                                            ...
                                                            >
                                                                ...
                                                                <div className="text-3xl font-black text-[#E0FE10]">The Reset Switch ✓</div>
                                                            ...
                                                            <div className="flex flex-col items-center gap-6 w-full">
                                                                <div className="flex items-center gap-2">
                                                                    ...
                                                                    <span className={`text-sm font-bold tracking-widest uppercase ${resetPhase === 'lockIn' ? 'text-[#E0FE10]' : resetPhase === 'disruption' ? 'text-red-400' : 'text-cyan-400'}`}>
                                                                        {resetPhase === 'lockIn' ? 'Lock In — Tap in rhythm' : resetPhase === 'disruption' ? 'Disruption!' : 'The Reset Switch — Re-engage NOW'}
                                                                    </span>
                                                                </div>
                                                                {resetPhase === 'disruption' ? (

...
const Q2Review2025 = () => {
  ...
  return (
    <ReviewArticleLayout
      metaTitle="Q2 2025: The Breakout Round | Pulse"
      metaDescription="Pulse Q2 2025: Morning Mobility proved the model—83 participants, 65% from referrals, 1,630 workouts. The creator-led community flywheel is real."

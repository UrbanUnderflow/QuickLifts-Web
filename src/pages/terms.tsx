      ...
      <main ref={useScrollFade()} className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <p className="text-zinc-400 text-lg">
              Pulse Intelligence Labs, Inc. retains rights to all content uploaded to the app
          ...
          <section>
            ...
            <p className="text-zinc-400 text-lg">
              Pulse Intelligence Labs, Inc. owns all intellectual property rights in and to
              ...
              without the express permission of Pulse Intelligence Labs, Inc.
            </p>
          </section>
        </div>
